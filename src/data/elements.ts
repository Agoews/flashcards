...
export const elements: ChemElement[] = [
  ...
  // transition metals within 1–38
  { atomicNumber: 21, symbol: "Sc", atomicMass: "45", nameEn: "Scandium", nameZh: "钪", groupLabel: "TM" },
  { atomicNumber: 22, symbol: "Ti", atomicMass: "48", nameEn: "Titanium", nameZh: "钛", groupLabel: "TM" },
  { atomicNumber: 23, symbol: "V", atomicMass: "51", nameEn: "Vanadium", nameZh: "钒", groupLabel: "TM" },
  { atomicNumber: 24, symbol: "Cr", atomicMass: "52", nameEn: "Chromium", nameZh: "铬", groupLabel: "TM" },
  { atomicNumber: 25, symbol: "Mn", atomicMass: "55", nameEn: "Manganese", nameZh: "锰", groupLabel: "TM" },
  { atomicNumber: 26, symbol: "Fe", atomicMass: "56", nameEn: "Iron", nameZh: "铁", groupLabel: "TM" },
  { atomicNumber: 27, symbol: "Co", atomicMass: "59", nameEn: "Cobalt", nameZh: "钴", groupLabel: "TM" },
  { atomicNumber: 28, symbol: "Ni", atomicMass: "59", nameEn: "Nickel", nameZh: "镍", groupLabel: "TM" },
  { atomicNumber: 29, symbol: "Cu", atomicMass: "64", nameEn: "Copper", nameZh: "铜", groupLabel: "TM" },
  { atomicNumber: 30, symbol: "Zn", atomicMass: "65", nameEn: "Zinc", nameZh: "锌", groupLabel: "TM" },
  ...
  // required additions not already present in your original list
  { atomicNumber: 47, symbol: "Ag", atomicMass: "108", nameEn: "Silver", nameZh: "银", groupLabel: "TM" },
  { atomicNumber: 48, symbol: "Cd", atomicMass: "112", nameEn: "Cadmium", nameZh: "镉", groupLabel: "TM" },
  { atomicNumber: 78, symbol: "Pt", atomicMass: "195", nameEn: "Platinum", nameZh: "铂", groupLabel: "TM" },
  { atomicNumber: 79, symbol: "Au", atomicMass: "197", nameEn: "Gold", nameZh: "金", groupLabel: "TM" },
  { atomicNumber: 80, symbol: "Hg", atomicMass: "201", nameEn: "Mercury", nameZh: "汞", groupLabel: "TM" },
  { atomicNumber: 92, symbol: "U", atomicMass: "238", nameEn: "Uranium", nameZh: "铀", groupLabel: "ACT" },

  // keep your existing entries (no duplicates)
